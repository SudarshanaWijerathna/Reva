...
from backend.predictions.LSTM.Housing.threshold import time_steps
import os
...
def _load_housing_df(csv_path=None):
...
def load_housing_model_and_scaler(model_path=None, scaler_path=None):
...
def predict_next_close_price(model, scaler, df=None, csv_path=None):
    ...
    check_scaler_domain("housing", last_60_scaled)
